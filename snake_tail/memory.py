...
def memory(sha256_digest, delete=False, update=False, name=None, description=None, tags=None, json=False, verify=True):
    url = SNAKE_URL + "/memory/" + sha256_digest
    if delete:
